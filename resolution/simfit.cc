...
//define piecewise fit
  const int npars=7;
  TF1* pcfit = new TF1("pcfit", fitFunction, 0, 4000, npars);

  double a1_initParam[npars]={1.000000E+03,2.000000E+03,9.174177E-01,-2.804269E-04,4.923222E-01,1.949095E+00,2.148115E-07};
  double a2_initParam[npars]={1.000000E+03,2.000000E+03,1.884868E+00,-4.778128E-04,1.473586E+00,2.377190E+00,1.838407E-07};
  double n1_initParam[npars]={1.000000E+03,2.000000E+03,5.832402E+00,-8.011467E-03,1.044511E+00,2.417945E+00,-1.386021E-07};
  double n2_initParam[npars]={1.000000E+03,2.000000E+03,2.825576E+00,1.622956E-03,2.884475E+00,5.111661E+00,-1.766191E-07};
  double mean_initParam[npars]={1.000000E+03,2.000000E+03,-6.228337E-01,-1.503949E-03,-3.029992E+00,6.311756E+00,6.808673E-07};
  double sigma_initParam[npars]={1.000000E+03,2.000000E+03,1.550485E+00,3.970662E-03,3.167940E+00,-1.969825E+00,-1.691749E-08};
...
// fit with piece-wise function from Ulascan
  ...
  for (int i=0; i<maxMassBin; i++) {
    ...
    char filename[100];
    sprintf(filename,"fixParamFit/Resolution_MH%d_%s_fixParam.pdf",massBin[i],channel);
    c1->SaveAs(filename);
